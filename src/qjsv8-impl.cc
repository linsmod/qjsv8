...
const char *version_string = "5.7.0 (MiniV8)";
const char *V8::GetVersion() { return version_string; }
void V8::ShutdownPlatform() { DebugBreak(); }
...
class
    MacroAssembler { // Ϊ���ܷ���v8::PropertyCallbackInfo��˽�б��������ò�����MacroAssembler
public:
  static JSValue objectTemplateGetter(JSContext *ctx, JSValueConst thisVal,
                                      void *userdata);
  static JSValue objectTemplateSetter(JSContext *ctx, JSValueConst thisVal,
                                      JSValueConst val, void *userdata);

  void *stub;
};

JSValue MacroAssembler::objectTemplateGetter(JSContext *ctx,
                                             JSValueConst thisVal,
                                             void *userdata) {
  qjsv8::V8Context *context = (qjsv8::V8Context *)JS_GetContextOpaque(ctx);
  qjsv8::V8Template::Accessor *accessor =
      (qjsv8::V8Template::Accessor *)userdata;

  qjsv8::V8String *name = new qjsv8::V8String(context, accessor->name);
  // name->ensureQjsVal(context);
  v8::Local<v8::Name> propertyName = (toV8Local(name));

  qjsv8::V8Object *thisValue = qjsv8::V8Object::create(context, thisVal);
  v8::Isolate *isolate = v8::Isolate::GetCurrent();

  void *returnValue[4] = {0};
  returnValue[0] = isolate;

  qjsv8::V8External external(accessor->data);
  ...
  args[v8::PropertyCallbackInfo<v8::Value>::kHolderIndex] =
      thisValue; // kHolderIndex
  args[v8::PropertyCallbackInfo<v8::Value>::kIsolateIndex] =
      isolate; // kIsolateIndex
  args[v8::PropertyCallbackInfo<v8::Value>::kReturnValueDefaultValueIndex] =
      nullptr; // kReturnValueDefaultValueIndex
  args[v8::PropertyCallbackInfo<v8::Value>::kReturnValueIndex] =
      &returnValue[2]; // kReturnValueIndex
  args[v8::PropertyCallbackInfo<v8::Value>::kDataIndex] =
      &external; // kDataIndex
  args[v8::PropertyCallbackInfo<v8::Value>::kThisIndex] =
      thisValue; // kThisIndex

  MacroAssembler infoStub; // ����ٵģ���ʵֻ��Ϊ�˵�ַռλ
  infoStub.stub = args;
  v8::PropertyCallbackInfo<v8::Value> *info =
      (v8::PropertyCallbackInfo<v8::Value> *)&infoStub;
  ...
  if (nullptr == *retVal)
    return JS_UNDEFINED;
  qjsv8::V8Value *ret =
      v8::Utils::openHandle<v8::Value, qjsv8::V8Value>((v8::Value *)(retVal));
  return ret->v(ret); // TODO:Free
}

JSValue MacroAssembler::objectTemplateSetter(JSContext *ctx,
                                             JSValueConst thisVal,
                                             JSValueConst val, void *userdata) {
  qjsv8::V8Context *context = (qjsv8::V8Context *)JS_GetContextOpaque(ctx);
  qjsv8::V8Template::Accessor *accessor =
  ...
  qjsv8::V8Value *value = new qjsv8::V8Value(context, val); // TODO:
  v8::Local<v8::Value> valueV8 = (toV8Local(value));
  ...
  v8::PropertyCallbackInfo<void> *info =
      (v8::PropertyCallbackInfo<void> *)&infoStub;
...
//             // * U-00010000 - U-001FFFFF: 1111 0xxx 10xxxxxx 10xxxxxx
//             10xxxxxx uint32_t highSur = u16char; uint32_t lowSur = p[++i];
//             // �Ӵ�����Ե�UNICODE�����ת��
...
//         if (u16char >= 0xD800 && u16char <= 0xDBFF) {
//             // * U-00010000 - U-001FFFFF: 1111 0xxx 10xxxxxx 10xxxxxx
//             10xxxxxx uint32_t highSur = u16char; uint32_t lowSur =
//             byteswap_ushort(p[++i]);
//             // �Ӵ�����Ե�UNICODE�����ת��
//             // 1���Ӹߴ������ȥ0xD800����ȡ��Ч10bit
//             // 2���ӵʹ������ȥ0xDC00����ȡ��Ч10bit
...
//             | ((c3 & 0x3FU) << 6) | (c4 & 0x3FU); if (codePoint >= 0x10000)
//             {
//                 // ��UTF-16�� U+10000 �� U+10FFFF ������16bit��Ԫ��ʾ, �������.
//                 // 1����������ȥ0x10000(�õ�����Ϊ20bit��ֵ)
//                 // 2��high ������ �ǽ���20bit�еĸ�10bit����0xD800(110110 00
//                 00000000)
//                 // 3��low  ������ �ǽ���20bit�еĵ�10bit����0xDC00(110111 00
//                 00000000) codePoint -= 0x10000; u16str +=
//                 ((char16_t)((codePoint >> 10) | 0xD800U)); u16str +=
//                 ((char16_t)((codePoint & 0x03FFU) | 0xDC00U));
//             } else
//             {
//                 // ��UTF-16�� U+0000 �� U+D7FF �Լ� U+E000 �� U+FFFF
//                 ��Unicode�����ֵ��ͬ.
//                 // U+D800 �� U+DFFF ����Ч�ַ�,
//                 Ϊ�˼���������������������(������򲻱���)
...
//             uint32_t codePoint = ((ch & 0x0FU) << 12) | ((c2 & 0x3FU) << 6) |
//             (c3 & 0x3FU); u16str += ((char16_t)codePoint);
//         }
//         break;
...
V8Isolate::V8Isolate() {
  ...
  // ensure a globalContext there;
  qjsv8::V8Context *ret = new qjsv8::V8Context(this, ctx);
  enterContext(ret);
  ...
  memset(m_globalizeHandles.data(), 0,
         sizeof(void *) * m_globalizeHandles.size());
  memset(m_handleScopeHandles.data(), 0,
         sizeof(void *) * m_handleScopeHandles.size());

  typedef v8::internal::Internals I;
  *I::GetRoot((v8::Isolate *)&m_apiPointer, I::kNullValueRootIndex) =
      (v8::internal::Object *)(new qjsv8::V8Value(nullptr, JS_NULL));
  *I::GetRoot((v8::Isolate *)&m_apiPointer, I::kTrueValueRootIndex) =
      (v8::internal::Object *)(new qjsv8::V8Value(nullptr, JS_TRUE));
  *I::GetRoot((v8::Isolate *)&m_apiPointer, I::kFalseValueRootIndex) =
      (v8::internal::Object *)(new qjsv8::V8Value(nullptr, JS_FALSE));
  *I::GetRoot((v8::Isolate *)&m_apiPointer, I::kUndefinedValueRootIndex) =
      (v8::internal::Object *)(new qjsv8::V8Value(nullptr, JS_UNDEFINED));
  *I::GetRoot((v8::Isolate *)&m_apiPointer, I::kEmptyStringRootIndex) =
      (v8::internal::Object *)(new qjsv8::V8String(ret, ""));
...
void V8Isolate::enterContext(V8Context *ctx) { m_currentCtxs.push_back(ctx); }

void V8Isolate::exitContext() {
  V8Context *top = m_currentCtxs.back();
...
JSContext *V8Isolate::getCurrentJsContext() { return getCurrentCtx()->ctx(); }
...
bool V8Isolate::isInContext() { return m_currentCtxs.size() > 0; }
...
JSValue V8Function::onV8FunctionWrap(JSContext *ctx, JSValueConst thisVal,
                                     int argc, JSValueConst *argv,
                                     void *userdata) {
  qjsv8::V8Function *self = (qjsv8::V8Function *)userdata;
  qjsv8::V8Isolate *isolate = qjsv8::V8Isolate::GetCurrent();

  qjsv8::V8Context *context = (qjsv8::V8Context *)JS_GetContextOpaque(ctx);
  miniv8ReleaseAssert(!!context, "onV8FunctionWrap fail\n");
  qjsv8::V8Object *thisValV8 = qjsv8::V8Object::create(context, self->v(self));

  qjsv8::V8Data dataV8(context, self->v(self));

  std::vector<void *> argValue;
  argValue.resize(argc + 2);

  for (int i = 0; i < argc; ++i) {
    qjsv8::V8Value *v = new qjsv8::V8Value(context, argv[argc - i - 1]);
    argValue[i] = v;
  }
  ...
  for (int i = 0; i < argc; ++i) {
    qjsv8::V8Value *v = (qjsv8::V8Value *)returnValue[i];
    delete v;
  }
...
JSValue V8Function::V8Function_v(V8Data *ptr) {
  ...
  self->m_qjsValue =
      JS_NewCFunction2(self->m_ctx->ctx(), onV8FunctionWrap, name.c_str(),
                       name.size(), JS_CFUNC_constructor, 0, self);
  return self->m_qjsValue;
}
...
void V8FunctionTemplate::functionTemplateCall(
    const v8::FunctionCallbackInfo<v8::Value> &info) {
  // �ڹ���ʵ����ʱ�򣬰�InstanceTemplate
  qjsv8::V8FunctionTemplate *self =
      (qjsv8::V8FunctionTemplate *)(v8::External::Cast(*info.Data())->Value());
  ...
  qjsv8::V8Object *obj =
      v8::Utils::openHandle<v8::Object, qjsv8::V8Object>(*objV8);
  ...
  //         { "generate", JS_PROP_WRITABLE | JS_PROP_CONFIGURABLE,
  //         JS_DEF_CFUNC, 0,{ 1, JS_CFUNC_generic,{ jsMt19937Generate } } }, {
  //         "haha", JS_PROP_WRITABLE | JS_PROP_CONFIGURABLE, JS_DEF_CGETSET,
  //         0,{ 0 } }
  //     };
  //
  //     JS_SetPropertyFunctionList(ctx->ctx(), obj->v(), jsMt19937ProtoFuncs,
  //     /*std::extent_v<decltype(jsMt19937ProtoFuncs)>*/ 2);
}
...
void V8Template::newTemplateInstance(qjsv8::V8Context *ctx,
                                     qjsv8::V8Object *obj) {
  JSValue v = obj->v(obj);
  obj->m_internalFieldCount =
      this->m_internalFieldCount > obj->m_internalFieldCount
          ? this->m_internalFieldCount
          : obj->m_internalFieldCount;

  printDebug(
      "v8::ObjectTemplate::NewInstance: %p, obj->m_internalFieldCount:%d\n",
      obj, obj->m_internalFieldCount);

  // ע�⣬���ʵ�����Ǹ�function
  // template��ԭ��������Ҫ���⴦��һ��
  for (std::map<std::string, JSValue>::iterator it = this->m_props.begin();
  ...
  JSCFunctionListEntry *accessorsFuncs =
      new JSCFunctionListEntry[this->m_accessors.size()];
  std::map<std::string, V8Template::Accessor>::iterator it =
      this->m_accessors.begin();
  for (int i = 0; it != this->m_accessors.end(); ++it, ++i) {
    const std::string &name = it->first;
    V8Template::Accessor *val = &it->second;
    miniv8ReleaseAssert(val->nameGetter || val->nameSetter,
    ...
    if (val->nameGetter)
      accessorsFuncs[i].u.getset.get.getter =
          &v8::MacroAssembler::objectTemplateGetter;
    if (val->nameSetter)
      accessorsFuncs[i].u.getset.set.setter =
          &v8::MacroAssembler::objectTemplateSetter;
    accessorsFuncs[i].u.getset.userdata = val;
  }
  JS_SetPropertyFunctionList(ctx->ctx(), v, accessorsFuncs,
                             this->m_accessors.size());
}

void V8String::ensureQjsVal(V8Context *ctx) {
  //   if (!ctx) {
  //     qjsv8::V8Isolate *isolate = qjsv8::V8Isolate::GetCurrent();
  //     ctx = isolate->getCurrentCtx();
  //   }
  //   if (!ctx) {
  //     DebugBreak();
  //     return;
...
const char *V8String::c_str() {
  if (m_contextual) {
    if (!ctx()) {
      DebugBreak();
      qjsv8::V8Isolate *isolate = qjsv8::V8Isolate::GetCurrent();
      auto *ctx = isolate->getCurrentJsContext();
      if (!ctx)
        return "[err-missing-context]";
      m_str = JS_ToCString(ctx, m_qjsValue);
    } else
      m_str = JS_ToCString(ctx(), m_qjsValue);
    m_contextual = false;
  }
...
std::string V8String::getStr() {
  if (m_contextual) {
    ...
    // }
    // const char *nameString = JS_ToCStringLen(ctx(), &len, m_qjsValue);
